CREATE TABLE Account_Master(Account_ID NUMBER(10) PRIMARY KEY,Account_Type VARCHAR2(25),Account_Balance NUMBER(15),Open_Date DATE,Customer_ID NUMBER(10) REFERENCES Customer(Customer_ID));
