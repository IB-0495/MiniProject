...
CREATE TABLE User_Table(Account_ID NUMBER(20) REFERENCES Account_Master(Account_ID),user_id NUMBER(20) PRIMARY KEY,login_password VARCHAR2(15),secret_question VARCHAR2(50),Transaction_password VARCHAR2(15),lock_status VARCHAR2(1));
